...
def print_tensors_in_checkpoint_file(file_name, tensor_name, all_tensors,
  ...
  try:
    ...
    if all_tensors or all_tensor_names:
      ...
      np.save('/tmp/variable_out.npy', reader.get_tensor(tensor_name))
...
python3 inspect_checkpoint.py \
    --file_name=/home/murphyhuang/dev/mldata/en_ch_translate_output_pct_20190618/ckpt-1000 \
    --tensor_name=model/symbol_bottom_inputs/_embedding_space/.ATTRIBUTES/VARIABLE_VALUE 
"""
